...
/**
 * NOTES:
 *  - you are free to remove the type and do it in javascript, but the signature must stay the same
 *  - you can modify the component to class component or any other variation if you so please
 */
 ...
 *   - BONUS2: create a similar component, which will be a link ('<a/>') instead of button
 */
